...
To close your notebook, do File-->Close and Halt.
Closing your web browser does NOT shut down jupyter. To do it, close the terminal/command line window that opened when you launched jupyter.
